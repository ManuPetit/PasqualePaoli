...
/* 
 * fichier de création de la page mentions
 * 
 */
session_start();
            ...
            <div class="row">
                <div class="boite">
                    ...
                    <div class="span12 text-center">
                        ...
                        <hr>
                        <h2>
                            <small><strong><?php if (isset($traduction['mentions_legales_header'])) echo $traduction['mentions_legales_header']; ?></strong></small> 
                        </h2>   
                        <hr>
                    </div>
                    <!-- FIN de ROW DU TITRE --> 
                    ...
                    if ($_SESSION['language']=='eng'){
                        include 'mentionen.php';
                    }
                    else{
                        include 'mentionfr.php';
                    }
                    ?>
                     <p>&nbsp;</p>
                </div>                
